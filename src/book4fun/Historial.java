        ...
        if(reservado == false){
           ...
           m.add(lTotalCreditos , medidas);
            ...
            try (Connection conn = BD.makeConnection()) {
                String sql = "SELECT FECHA_ENTRADA, FECHA_SALIDA, CREDITOS_TOTALES FROM RESERVAS WHERE ID_VIVIENDA = ? AND ID_USUARIO = ?";
                ...
                try (PreparedStatement statement = conn.prepareStatement(sql)) {
                    ...
                    try (ResultSet resultSet = statement.executeQuery()) {
                        if (resultSet.next()) {
                            ...
                            creditos = resultSet.getInt("CREDITOS_TOTALES");
           ...
           JLabel mensaje3  = new JLabel(valorFechaEntrada + "  a  " + valorFechaSalida);
           fuente = new Font("Segoe UI", Font.PLAIN, 25);
           mensaje3 .setFont(fuente);
           medidas = new AbsoluteConstraints(400, 330, 500, 100);
           m.add(mensaje3 , medidas);
           ...
           JLabel etiquetaPrecioDia = new JLabel("Creditos totales: ");
           fuente = new Font("Segoe UI Black", Font.PLAIN, 15);
           ...
           JLabel etiquetaPrecioDia2 = new JLabel(String.valueOf(creditos));
           fuente = new Font("Segoe UI", Font.PLAIN, 15);
           etiquetaPrecioDia2.setForeground(Color.BLACK);
           etiquetaPrecioDia2 .setFont(fuente);
           medidas = new AbsoluteConstraints(570, 185, 300, 100);
           m.add(etiquetaPrecioDia2 , medidas);
           
           JLabel etiquetaPrecioDia3 = new JLabel("Euros: " + (creditos * 10));
           fuente = new Font("Segoe UI", Font.PLAIN, 15);
           etiquetaPrecioDia3.setForeground(Color.BLACK);
           etiquetaPrecioDia3 .setFont(fuente);
           medidas = new AbsoluteConstraints(600, 185, 300, 100);
           m.add(etiquetaPrecioDia3 , medidas);
